...
const en = {
  ...
  hero: {
    ...
    headlineA: "Agency-level digital work",
    headlineB: "",
    headlineC: "without the agency overhead.",
    headlineHighlight: "agency overhead",
    bio:
      "I design, build and improve websites, forms, lead flows and business workflows — with one clear point of contact, focused scope and faster delivery.",
